...
const texto = "0";
if (texto === 0)
	// o operador de tríplice igualdade compara o valor e o tipo dos conteúdos
	console.log("Os dados são iguais.");
else if (true) console.log("Segundo if - if aninhado.");
else console.log("Saída..."); // erro na hora de pensar o código...
...
const modifiedNames = names.map(function (name) {
	if (name == "Paulo") return "Paulo Sampaio";
	else return name;
});
...
Product.test();
const tenis = new Tenis("tenis Nike Jordan", 12000.0, "42");
